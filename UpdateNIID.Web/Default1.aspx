<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default1.aspx.cs" Inherits="NIID_WEB._Default" %>
        ...
        <div class="container">
            <div class="row">
                <div class="pull-left">
                    ...
                    &nbsp;&nbsp; 
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" CellPadding="10" CellSpacing="10" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        <asp:ListItem Selected="True" Value="1">All</asp:ListItem>
                        <asp:ListItem Value="0">Successful</asp:ListItem>
                ...
                <div class="pull-right">
                    <div class="form-inline">
                        ...
                        <asp:TextBox ID="txtStartDate" placeholder="Start Date" class="form-control small" runat="server" Width="150px"></asp:TextBox>
                        <asp:TextBox ID="txtEndDate" placeholder="End Date" class="form-control small" runat="server" Width="150px"></asp:TextBox>
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" CaptionAlign="Left" CellPadding="10" ForeColor="#333333" GridLines="None" Width="100%" AutoGenerateColumns="False"
                            EmptyDataText="No data available." Font-Names="Century Gothic" Font-Size="11pt" HorizontalAlign="Left" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="True" OnRowDataBound="GridView2_RowDataBound">
